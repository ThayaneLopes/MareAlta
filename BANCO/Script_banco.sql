...
rua_avenida varchar(50),complemento varchar(100), cidade varchar(100),
cep varchar(9),ativo tinyint(1),horario_funcionamento varchar(50),
...
cep varchar(9),precisa_voluntario tinyint(1),quant_de_familias int,
foreign key(cidade) references cidade_risco(id));

create table voluntario(id int auto_increment primary key,
cpf varchar(14) unique,nome varchar(100),orgao_publico varchar(30),
