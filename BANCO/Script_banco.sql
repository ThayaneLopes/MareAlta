...
nome varchar(100) unique,responsavel varchar(30) unique,telefone_1 varchar(15),
...
nome varchar(30) unique,responsavel varchar(30) unique,telefone_1 varchar(15),
telefone_2 varchar(15), estado varchar(2), bairro varchar(30),
...
cpf varchar(11) unique,nome varchar(30),orgao_publico varchar(30),
